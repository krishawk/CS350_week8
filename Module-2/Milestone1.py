...
while repeat:
    ...
    # Loop from 0 to 100 in increments of 5
     for dutyCycle in range(0, 101, 5):
        pwm18.ChangeDutyCycle(dutyCycle)  # Update duty cycle
        time.sleep(0.1)  # stopping for 1/10th of a second
     else: 
    # Loop from 0 to 100 in increments of 5
      for dutyCycle in range(101, 0, 5 ):
        pwm18.ChangeDutyCycle(dutyCycle)  # Update duty cycle
        time.sleep(.1)  # Pause for 1/10th of a second
